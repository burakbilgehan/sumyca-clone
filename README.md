...
- Harita: Leaflet + OpenStreetMap tiles. İngilizce mahalle etiketleri (`src/data/neighborhoods.ts`, zoom'a göre kademeli, çakışanlar ayıklanır) OSM etiketlerinin üstünde ama hat/istasyon/ilan pinlerinin altında bir pane'de çizilir. Metro istasyonları z15'te sadece aktarma istasyonları olarak, z16+ hepsi + ad etiketleriyle görünür.
